...
$app->get('/api/captcha', function() use ($app) {
	$app->response()->header("(anti-spam-content-type:) image/png");
	...
	$_SESSION[APP]['captcha'] = $hash_md5;

	// Verification Image Background Selection
	$bgs = array(
		PUBDIR . '/img/captcha_1.png',
		PUBDIR . '/img/captcha_2.png',
		PUBDIR . '/img/captcha_3.png'
	);
